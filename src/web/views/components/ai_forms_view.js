...
function renderAIInputForm() {
    return div(
        ...
        form({ 
            ...
            // Selected presets indicator
            div({ 
                id: 'selected-presets-indicator',
                class: 'selected-presets-indicator',
                style: `
                    margin-top: 0.75em;
                    padding: 0.75em;
                ...
                div({ 
                    style: 'color: var(--text-secondary); margin-bottom: 0.5em; font-weight: 600;'
                }, '🎯 Selected Presets:'),
                div({ 
                    id: 'selected-presets-list',

...
export class ContentManager implements IContentManager {
  ...
  addPrompt(prompt: PromptDefinition): void {
    ...
    l.v(`${this.serverName}: Prompt '${prompt.id}' added and handler registered`);
  }
  ...
  updatePrompt(id: string, updates: Partial<PromptDefinition>): PromptDefinition {
    ...
    l.v(`${this.serverName}: Prompt '${id}' updated and handler re-registered`);
  ...
  deletePrompt(id: string): boolean {
    ...
    l.v(`${this.serverName}: Prompt '${id}' deleted and handler removed`);
    return true;
  }
  ...
  addResource(resource: ResourceDefinition): void {
    ...
    l.v(`${this.serverName}: Resource '${resource.id}' added and handler registered`);
  }
  ...
  updateResource(id: string, updates: Partial<ResourceDefinition>): ResourceDefinition {
    ...
    l.v(`${this.serverName}: Resource '${id}' updated and handler re-registered`);
  ...
  deleteResource(id: string): boolean {
    ...
    l.v(`${this.serverName}: Resource '${id}' deleted and handler removed`);
    return true;
  }
  ...
  setupAllHandlers(): void {
    ...
    l.v(`${this.serverName}: All content handlers registered`);
  }
